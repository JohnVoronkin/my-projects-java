package ru.simple.java.test.lists.arrays;
...
public class ArrayListTest {
  ...
  public static void main(String[] args) {
    ...
    // create an empty array lists with an initial capacity
    ArrayList<Integer> arrlist = new ArrayList<Integer>(5);

    // use add() method to add elements in the lists
    arrlist.add(35);
    arrlist.add(20);
    arrlist.add(25);
    ...
    // let us print all the elements available in lists
